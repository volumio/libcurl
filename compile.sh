...
# Version 7.74
wget http://deb.debian.org/debian/pool/main/c/curl/curl_7.74.0.orig.tar.gz
tar xf curl_7.74.0.orig.tar.gz
cd curl-7.74.0/
wget http://deb.debian.org/debian/pool/main/c/curl/curl_7.74.0-1.2~bpo10+1.debian.tar.xz
tar xf curl_7.74.0-1.2~bpo10+1.debian.tar.xz
